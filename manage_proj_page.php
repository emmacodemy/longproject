	...
	<table class="table table-striped table-bordered table-condensed table-hover">
		<thead>
			<tr>
				...
				<th><?php
					print_manage_project_sort_link( 'manage_proj_page.php', lang_get( 'view_status' ), 'view_status', $t_direction, $f_sort );
					print_sort_icon( $t_direction, $f_sort, 'view_status' ); ?>
				</th>
				<th><?php
...
<?php
		...
		while( 0 < count( $t_stack ) ) {
			...
			<tr>
				...
				<td><?php echo  $t_project['view_state'];  ?></td>
