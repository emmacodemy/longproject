...
$t_issue = array(
	...
	'current_status' => gpc_get_string( 'current_status' ),
	'escalation' => gpc_get_string('escalation'),
	'resolved_witin'=> gpc_get_string('resolved_witin'),
	'resolved_via' => gpc_get_string('resolved_via'),
...
$t_system_impact = gpc_get_string("system_impact",'');

if(!is_blank($t_system_impact)){
	$t_issue['system_impact'] = $t_system_impact;
}
...
// $t_issue_typusing deslib for classification in kagglee = gpc_get_string('issue_type','');
// if( !is_blank($t_issue_type)){
// 	$t_issue['issue_type'] = $t_issue_type;
// }
...
$t_issue_logged = gpc_get_string('issue_logged',null);
if($t_due_date !==null){
	$t_issue['issue_logged'] = $t_issue_logged;
}
...
if( $f_report_stay ) {
	$t_fields = array(
		...
		'os', 'os_build', 'target_version', 'build', 'view_state', 'due_date','issue_type',
		'current_status'
	);
