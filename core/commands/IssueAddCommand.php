...
class IssueAddCommand extends Command {
	...
	function validate() {
		...
		$this->issue->current_status =isset( $t_issue['current_status'])? $t_issue['current_status'] : '';
		$this->issue->escalation = $t_issue['escalation'];
		$this->issue->resolved_witin = $t_issue['resolved_witin'];
		$this->issue->resolved_via = $t_issue['resolved_via'];
		$this->issue->system_impact = isset($t_issue['system_impact']) ? $t_issue['system_impact'] : '';
