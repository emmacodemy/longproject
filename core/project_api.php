 ...
 * @return integer
 */
function project_create( $p_name, $p_description, $p_status,$p_sla_info, $p_view_state, $p_file_path = '', $p_enabled = true, $p_inherit_global = true ) {
	...
	$t_query = 'INSERT INTO {project}
					( name, status, enabled, view_state, file_path, description, inherit_global ,sla_info)
				  VALUES
					( ' . db_param() . ', ' . db_param() . ', ' . db_param() . ', ' . db_param() . ', ' . db_param() . ', ' . db_param() . ', ' . db_param() .','.db_param(). ')';

	db_query( $t_query, array( $p_name, (int)$p_status, $c_enabled, $p_view_state, $p_file_path, $p_description, $p_inherit_global,$p_sla_info ) );
 ...
 * @return void
 */
function project_update( $p_project_id, $p_name, $p_description, $p_status, $p_view_state, $p_file_path, $p_enabled, $p_inherit_global,$p_sla_info ) {
	...
	$t_query = 'UPDATE {project}
				  SET name=' . db_param() . ',
					...
					sla_info='.db_param().'
				  WHERE id=' . db_param();
	db_query( $t_query, array( $p_name, (int)$p_status, $c_enabled, $p_view_state, $p_file_path, $p_description, $c_inherit_global,$p_sla_info, $p_project_id ) );
