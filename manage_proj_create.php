...
$f_sla_info     = gpc_get_string('sla_info');
...
$t_project_id = project_create( strip_tags( $f_name ), $f_description, $f_status, $f_sla_info,$f_view_state, $f_file_path, true, $f_inherit_global );
